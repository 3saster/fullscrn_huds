extend Class SpecialHexenStatusBar
{
	void DrawSplit ()
	{
		...
		if (CPlayer.mo is "ClericPlayer")
		{
			...
			if (CheckInventory(ULTIMATE[0])) DrawImage("WPFULL1", (-93, -31), DI_ITEM_OFFSETS|DI_SCREEN_RIGHT_BOTTOM, alpha:alphaFloatGraph);
			else
			{
		...
		else if (CPlayer.mo is "MagePlayer")
		{
			...
			if (CheckInventory(ULTIMATE[1])) DrawImage("WPFULL2", (-93, -31), DI_ITEM_OFFSETS|DI_SCREEN_RIGHT_BOTTOM, alpha:alphaFloatGraph);
			else
			{
		...
		else // if (Cplayer.mo is "FighterPlayer")
		{
			...
			if (CheckInventory(ULTIMATE[2])) DrawImage("WPFULL0", (-93, -31), DI_ITEM_OFFSETS|DI_SCREEN_RIGHT_BOTTOM, alpha:alphaFloatGraph);
			else
			{
