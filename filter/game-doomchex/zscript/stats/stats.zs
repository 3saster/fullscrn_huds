extend Class SpecialDoomStatusBar
{
	...
	protected virtual void DrawLevelStats (statFont sfnt)
	{
		...
		if(itempos   == BOTTOMLEFT) DrawStatLine(sfnt,ifound == Level.total_items     ? compColor : Font.CR_WHITE, (sPush,-bHeight-textSize*bottomLeftTotal++) ,items,alphaFloat);
		if(secretpos == BOTTOMLEFT) DrawStatLine(sfnt,sfound == Level.total_secrets   ? compColor : Font.CR_WHITE, (sPush,-bHeight-textSize*bottomLeftTotal++) ,secrets,alphaFloat);
		if(killpos   == BOTTOMLEFT) DrawStatLine(sfnt,mkilled == Level.total_monsters ? compColor : Font.CR_WHITE, (sPush,-bHeight-textSize*bottomLeftTotal++) ,kills,alphaFloat);
		...
		if(secretpos == BOTTOMRIGHT) DrawStatLine(sfnt,sfound == Level.total_secrets   ? compColor : Font.CR_WHITE, (-sPush-fnt.StringWidth(secrets),-bHeight-textSize*bottomRightTotal++),secrets,alphaFloat);
		if(itempos   == BOTTOMRIGHT) DrawStatLine(sfnt,ifound == Level.total_items     ? compColor : Font.CR_WHITE, (-sPush-fnt.StringWidth(items),  -bHeight-textSize*bottomRightTotal++)  ,items,alphaFloat);
		if(killpos   == BOTTOMRIGHT) DrawStatLine(sfnt,mkilled == Level.total_monsters ? compColor : Font.CR_WHITE, (-sPush-fnt.StringWidth(kills),  -bHeight-textSize*bottomRightTotal++)  ,kills,alphaFloat);
